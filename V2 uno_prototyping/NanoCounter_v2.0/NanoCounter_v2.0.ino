...
const int count1EE = 0;
const int count2EE = 1;
const int count3EE = 2;
const int count4EE = 3;
const int count5EE = 4;
const int count6EE = 5;
...
void setup() {
  EEPROM.get(count1EE, count1);
  EEPROM.get(count2EE, count2);
  EEPROM.get(count3EE, count3);
